					...
					<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 medium-padding100">
						<div class="crumina-module-img-content">
							<div class="crumina-module crumina-heading">
								<h3 class="heading-title">Who We Are?</h3>
								<div class="heading-text">
                  Riowex is a digital agency providing professional SEO and web development solutions that help businesses grow and compete. We understand your business objectives and aim at building you a website that stands out in today’s competitive online world. We have been serving businesses with website design, strategic web design, website revamp, SEO solutions and web integrated solutions since 2010. Riowex is dedicated towards building attractive and functional websites that wow your customers and help you succeed. We create one-of-a-kind websites that reflect your business, help grow your brand and improve your audience’s engagement.
								</div>
							</div>
						</div>
            <div class="row">
...
<section class="">
	<div class="container">
		<div class="row">
			<div class="crumina-module crumina-module-img-bottom">
				<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 medium-padding100">
					<div class="crumina-module-img-content">
						<div class="crumina-module crumina-heading">
							<h3 class="heading-title">Our Philosophy</h3>
							<div class="heading-text">
                We value the clients and develop responsive web solutions for our clients. Riowex’s clients notice a marked improvement in both leads and revenue generation since upgrading to responsive websites. We have an incredible track record of producing beautiful websites and help lift the site to top of search results. We patiently help our clients understand the process and walk them through each step of the SEO program. We are passionate about helping your business reach its goals and with Riowex, you will get a custom plan that fits the business objectives of your company.
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="crumina-module crumina-module-img-bottom">
				<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 medium-padding100">
					<div class="crumina-module-img-content">
						<div class="crumina-module crumina-heading">
							<h3 class="heading-title">We care about your business as our own</h3>
							<div class="heading-text">
                We give individual attention to each of our clients and build a long-lasting relationship based on trust and satisfaction.
                <br>
                Working on different web and mobile design and development projects we consistently deliver solutions that exceed expectations.
                <br>
	...
	<div class="container">
		<div class="row">
			<div class="crumina-module crumina-module-img-bottom">
                ...
                <br>
                <p>The process we follow is simple and transparent, so you know exactly where your project stands at every stage. Our customer-centric approach ensures that we channelize our energy into creating completely distinct websites and apps that have the desired effect, be it increasing leads or boosting sales.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-teammembers-item">
						...
						<div class="teammember-content">
							...
							<div class="teammembers-item-prof">CEO and Founder</div>

							<a href="#" class="h5 teammembers-item-name">Reza Alijan Nezhad</a>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-teammembers-item">
						...
						<div class="teammember-content">
							...
							<div class="teammembers-item-prof">Business Development</div>

							<a href="#" class="h5 teammembers-item-name">Neda Alikhani</a>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-teammembers-item">
						...
						<div class="teammember-content">
							...
							<div class="teammembers-item-prof">Senior Technical Engineer</div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-teammembers-item">
						...
						<div class="teammember-content">
							...
							<div class="teammembers-item-prof">Digital Marketing Director</div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-teammembers-item">
						...
						<div class="teammember-content">
							...
							<div class="teammembers-item-prof">Back-End Developer</div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-teammembers-item">
						...
						<div class="teammember-content">
							...
							<div class="teammembers-item-prof">Senior Developer</div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-teammembers-item">
						...
						<div class="teammember-content">
							...
							<div class="teammembers-item-prof">Technical Head</div>
